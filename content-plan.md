# 주간 글감 계획 (2026-08-25 ~ 2026-08-29, 화~토 자동화 테스트용)

일요일 플래닝 사이클을 못 거치고 수동으로 채운 테스트 목록. 매일 09:00 KST 트리거가 위에서부터 하나씩 체크하며 초안을 만든다.

- [ ] Docker 기초 개념과 자주 쓰는 명령어 | docker-basics | infra | [docker] | [container, cli] | tutorial | 컨테이너가 뭘 해결하는지와 자주 쓰는 docker 명령어를 정리한다
- [ ] Redis 자료구조와 캐싱 전략 | redis-basics | infra | [redis] | [caching, in-memory] | study | Redis의 주요 자료구조와 캐시로 쓸 때 고려할 점을 정리한다
